...
class UploadMessage:
    ...
    def success(content: MessageContent):  # @NoSelf
        return UploadMessage(severity=constants.SUCCESS, content=content)

    def warning(content: MessageContent):  # @NoSelf
...
class UploadZipForm(forms.Form):
    ...
    def clean_zip_file(self):
        ...
        try:
            zipf = zipfile.ZipFile(zip_file)  # @UnusedVariable
        ...
        zipf.close()  # Close file in all cases.
        return zip_file
    ...
    def save(self, request=None, zip_file=None):
        ...
        upload_messages = upload_photos_to_site(current_site, zipf, gallery, photo_defaults)
...
def upload_photos_to_site(site: Site, zipf: zipfile.ZipFile, gallery: Gallery, photo_defaults: PhotoDefaults)\
        -> List[UploadMessage]:
    upload_messages = []
    count = 1
